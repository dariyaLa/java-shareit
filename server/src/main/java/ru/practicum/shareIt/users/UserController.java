...
public class UserController {
    ...
    public UserDto create(@RequestBody @Valid UserDto userDto) {
        log.info("Получен POST запрос к эндпоинту: /ru.practicum.shareIt.gateway.users, Строка параметров запроса: '{}'",
                userDto);
    ...
    public Collection<UserDto> findAll() {
        log.debug("Получен GET запрос к эндпоинту: /ru.practicum.shareIt.gateway.users");
        return userService.findAll();
    }

    @GetMapping("/{id}")
    public UserDto find(@PathVariable int id) {
        log.debug("Получен GET запрос к эндпоинту: /ru.practicum.shareIt.gateway.users, Строка параметров запроса: '{}'",
                id);
    ...
    public void deleteLike(@PathVariable int id) {
        log.info("Получен DELETE запрос к эндпоинту: /ru.practicum.shareIt.gateway.users, Строка параметров запроса: '{}'",
                id);
    ...
    public UserDto update(@RequestBody UserDto updateData, @PathVariable int id) {
        log.info("Получен PATCH запрос к эндпоинту: /ru.practicum.shareIt.gateway.users, Строка параметров запроса: '{}'",
                id);
        Optional<UserDto> userFindId = userService.find(id);
        if (userFindId.isEmpty()) {
            throw new NotFoundData("Not found data");
