...
//
//        mvc.perform(post("/ru.practicum.shareIt.gateway.users.items")
...
//                .thenReturn(java.util.Optional.ofNullable(itemDto));
//
//        mvc.perform(patch("/ru.practicum.shareIt.gateway.users.items/{itemId}", 1)
...
//    void getItemExpTest() {
//        assertThatThrownBy(
//                () -> mvc.perform(get("/ru.practicum.shareIt.gateway.users.items/{itemId}", 1)
//                                .header("${headers.userId}", 1)
//                                .content(mapper.writeValueAsString(itemDto))
//                                .characterEncoding(StandardCharsets.UTF_8)
//                                .contentType(MediaType.APPLICATION_JSON)
...
//        assertThatThrownBy(
//                () -> mvc.perform(post("/ru.practicum.shareIt.gateway.users.items", 1)
//                        .header("${headers.userId}", 1)
//                        .content(mapper.writeValueAsString(itemDto))
//                        .characterEncoding(StandardCharsets.UTF_8)
//                        .contentType(MediaType.APPLICATION_JSON)
...
//        assertThatThrownBy(
//                () -> mvc.perform(patch("/ru.practicum.shareIt.gateway.users.items/{id}", 1)
//                        .header("${headers.userId}", 1)
//                        .content(mapper.writeValueAsString(itemDto))
//                        .characterEncoding(StandardCharsets.UTF_8)
//                        .contentType(MediaType.APPLICATION_JSON)
...
//                .thenReturn(java.util.Optional.ofNullable(itemDto));
//
//        mvc.perform(get("/ru.practicum.shareIt.gateway.users.items/{id}", 1)
//                        .header("${headers.userId}", 1L)
//                        .content(mapper.writeValueAsString(itemDto))
//                        .characterEncoding(StandardCharsets.UTF_8)
//                        .contentType(MediaType.APPLICATION_JSON)
...
//
//        mvc.perform(get("/ru.practicum.shareIt.gateway.users.items")
//                        .header("${headers.userId}", 1L)
//                        .content(mapper.writeValueAsString(itemDto))
//                        .characterEncoding(StandardCharsets.UTF_8)
//                        .contentType(MediaType.APPLICATION_JSON)
...
//                .thenReturn(itemDtoCollection);
//
//        mvc.perform(get("/ru.practicum.shareIt.gateway.users.items/search")
//                        .param("text", "test")
//                        .header("${headers.userId}", 1L)
//                        .content(mapper.writeValueAsString(itemDto))
//                        .characterEncoding(StandardCharsets.UTF_8)
...
//
//        mvc.perform(post("/ru.practicum.shareIt.gateway.users.items/{itemId}/comment", 1L)
//                        .header("${headers.userId}", 1L)
